...
namespace FF1Lib
{
	public partial class FF1Rom : NesRom
	{
		...
		// Remove all out of battle only spells and Cure 4
		private readonly List<byte> SpellsToRemove = new List<byte> { 48, 24, 38, 40, 41, 33, 56 }; // Cure 4, Pure, Warp, Soft, Exit, Life, Life 2
		...
		public void CastableItemTargeting()
		{
			...
			// Writes the spell name rather than the item name, not in the .asm
